...
<div id="divmenu">
		...
		<a href="${pageContext.request.contextPath}/showProductByPage?category=生鲜">生鲜</a>
		<a href="${pageContext.request.contextPath}/showProductByPage?category=食品">食品</a> 
		<a href="${pageContext.request.contextPath}/showProductByPage?category=鞋靴">鞋靴</a> 
		<a href="${pageContext.request.contextPath}/showProductByPage?category=百货">百货</a> 
		<a href="${pageContext.request.contextPath}/showProductByPage?category=提包">提包</a>
